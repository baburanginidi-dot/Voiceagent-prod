    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-[#EAF4FF] to-[#F9FBFF] p-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-[0_8px_30px_rgba(0,88,255,0.15)] p-8">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-[#0058FF] text-white font-bold py-3 px-4 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0058FF] transition-transform transform hover:scale-105"
          >
            Start Onboarding
          </button>
        </form>
